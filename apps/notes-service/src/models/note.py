...
class PhotoNote(SQLModel, table=True):
    ...
    topic_id: _uuid.UUID | None = Field(default=None, foreign_key="topics.id", index=True)
    ...
    ocr_text: str | None = None  # Extracted by Qwen3-VL vision model
    ai_summary: str | None = None  # AI-generated study summary
